...
root_folder_success = common.get_property_value(properties_file_name,'root_folder_success_'+report)
print('root_folder_success')
print(root_folder_success)
common.find_folder_name(root_folder_success)
...
root = root_folder_success
for fname in os.listdir(root):
    if os.path.isfile(os.path.join(root, fname)):
        print(fname)

        #SUCCESS_UPLOAD_VEHICLE+20180905_080054.csv
