...
sql = "select [customer],[month_end],[dispatcher_type],[vehicle_type],[service_type],[vehicle_count],[trip_count],[uploadedon],[createdon] from [%s].[dbo].[vw_upload_easy_trip] order by [customer],[month_end],[dispatcher_type],[vehicle_type],[service_type],[uploadedon],[createdon]" % (database_vfh)
print("sql")
print(sql)
