...
report_name = "EASY_TRIP"

import json
old_header = ['month end (mm/dd/yyyy)' ,'dispatcher type' ,'vehicle type' ,'service type' ,'vehicle count' ,'trip count']
print('old_header')
print(old_header)
...
sql = "select [customer],[month end (mm/dd/yyyy)],[dispatcher type],[vehicle type],[service type],[vehicle count],[trip count] from [%s].[dbo].[vw_gen_easy_trip] order by [customer],[dispatcher type],[vehicle type],[service type]" % (sql_server_database)
print("sql")
print(sql)
