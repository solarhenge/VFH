...
report_name = "EASY_DRIVER"

import json
old_header = ['month end (mm/dd/yyyy)','driver''s last name','driver''s first name','driver''s middle name','driver''s license','driver''s id','activation date of driver (mm/dd/yyyy)','deactivation date of driver (mm/dd/yyyy)']
print('old_header')
print(old_header)
...
sql = "select [customer] ,[month end (mm/dd/yyyy)] ,[driver's last name] ,[driver's first name] ,[driver's middle name] ,[driver's license] ,[driver's id] ,[activation date of driver (mm/dd/yyyy)] ,[deactivation date of driver (mm/dd/yyyy)] from [%s].[dbo].[vw_gen_easy_driver] order by [customer],[driver's id],[driver's last name],[driver's first name]" % (sql_server_database)
print("sql")
print(sql)
